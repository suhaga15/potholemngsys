	...
	<body>		
		<div class="main">
			...
			<div class="row2">
				...
				<div class="row2col2">
				<p class="content" id="greeting">This is the list of workers who had been allocated work. Enter worker ID to acknowledge work completion: </p>
				<form action='show_free.php' method='post' onSubmit='return clicked();'>
                ...
                $result= mysqli_query($db_con,"SELECT * FROM worker WHERE busy='y'");				
